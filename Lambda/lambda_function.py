...
def validate_data(birthday, dollars, currency, intent_request):
    """
    Validates the data provided by the user.
    """

    # Validate that the user is between 21 and 65 years old
    if birthday is not None:
        ...
        if age < 21:
            return build_validation_result(
                False,
                "birthday",
                "You should be at least between the ages of 21 and 65 years old to use this service, "
...
# Get slots values
  ...
  # Explicitly parse currency as string and make it uppercase
    ...
    # Get the investment amount / risk levels and make recommendation for investment portfolio.
    ...
    return close(
        ...
        "Fulfilled",
        {
           ...
           for your retirement, investing ${} with risk level of {}, it is recommended you % in AGG and % in SPY
           for your investment porfolio.
            """.format(
